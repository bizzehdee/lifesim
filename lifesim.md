...
### Age & Senescence
No hard lifespan in v1 — organisms are immortal until starvation or predation. Turnover already emerges from the famine/predation cycles (§5.3). An optional `senescence` config knob (default **off**) leaves aging as a later tuning experiment.
