...
public static class MetricsExporter
{
    ...
    [
        ...
        "avg_env_radius", "avg_org_radius", "avg_sensory_acuity", "avg_metabolic_efficiency",
        "avg_armour", "avg_evasion", "avg_toxicity", "avg_plasticity", "avg_learning_decay", "avg_sexuality", "avg_share_fraction", "avg_cell_count",
    ...
    public static string CsvRow(long tick, SimulationMetrics metrics)
    {
        ...
        var fields = new[]
        {
            ...
            metrics.KinDirectedShares.ToString(CultureInfo.InvariantCulture),
            metrics.NonKinShares.ToString(CultureInfo.InvariantCulture),
            Num(metrics.MeanHelpGiven),
            ...
            Num(metrics.TraitAverages.Armour),
            Num(metrics.TraitAverages.Evasion),
            Num(metrics.TraitAverages.Toxicity),
            Num(metrics.TraitAverages.Plasticity),
            Num(metrics.TraitAverages.LearningDecay),
            Num(metrics.TraitAverages.Sexuality),
