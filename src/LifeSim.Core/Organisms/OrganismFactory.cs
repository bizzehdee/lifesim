...
{
    public static Organism Create(long id, Genome genome, NamingConfig namingConfig, double initialEnergy, int x, int y) =>
        new(id, genome, OrganismNamer.Name(id, namingConfig), initialEnergy, x, y);
}
